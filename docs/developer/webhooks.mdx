...
You can create your own [Webhook](../integrations/generic-webhooks) types and add them to Freeform.

## Setup Guide<Badge type="feature" text="Revised in 5.0+" />

The creation of a custom Webhook integration in Freeform will require using a custom [Craft module](https://craftcms.com/docs/5.x/extend/module-guide.html). This guide assumes you already have that knowledge. If not, please [check out the guide](../user-guides/guides/developer/building-a-custom-module) we have.

:::tip
[View the guide on how to build a custom module.](../user-guides/guides/developer/building-a-custom-module)
:::
