...
import DemoTemplatesPhoto from './assets/img/diagnostics.png';
...
](../user-guides/guides/testing/troubleshooting-form-issues)
:::

<Photo img={DemoTemplatesPhoto} alt="Demo Templates" />

<Player
  url="https://www.youtube.com/watch?v=bxJtIZNAIoU"
  muted
  loop
  playing
  width="100%"
...
:::tip
[How do I completely uninstall / remove the demo templates when done?](guides/remove-demo-templates/)
:::
