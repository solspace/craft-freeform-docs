...
[Formatting Templates](../templates/formatting/) are predefined templates that you can specify for forms to handle simplified rendering of the form on the front end. You can have as many as you wish, and customize them however you like.
...
- View the [reCAPTCHA](../integrations/recaptcha/) or [hCaptcha](../integrations/hcaptha) integration documentation for more information about setting up and configuring.
...
- [Google Tag Manager](../user-guides/guides/submission-data/google-tag-manager)
...
- [Email Alerts](../configuration/notices-alerts/) <BadgeGroup><Badge type="lite" text="Lite" /><Badge type="pro" text="Pro" /></BadgeGroup>
- [Weekly Digest](../configuration/notices-alerts/) <BadgeGroup><Badge type="lite" text="Lite" /><Badge type="pro" text="Pro" /></BadgeGroup>
