...
<Tabs>
  <TabItem value="index" label="index.twig" default>
``` twig
...
````
  ...
  <TabItem value="_main" label="_main.css">
``` twig
...
````
  ...
  <TabItem value="_row" label="_row.twig">
``` css
/* LAYOUT */
html, body {
...
/_ FILE UPLOAD DRAG & DROP FIELDS _/
.freeform-file-dnd**input {
background-color: #ffffff !important;
border: 1px dashed #6c757d !important;
}
.freeform-file-dnd**input input {
display: none !important;
}
.freeform-file-dnd**placeholder {
font: italic 200 16px sans-serif !important;
color: #969696;
}
.freeform-file-dnd**input [data-messages] > li[data-error],
.freeform-file-dnd**input [data-field-errors] > li[data-error] {
font: 200 16px sans-serif;
color: #dc3545;
margin-top: 15px;
}
.freeform-file-dnd**input [data-field-errors] > li {
color: #dc3545;
}

/_ SIGNATURE FIELDS _/
...
````
  ...
  <TabItem value="_main.js" label="_main.js">
``` js
...
<Tabs>
  <TabItem value="_default_" label="_default.twig" default>
``` twig
{{ field.render }}
```
  </TabItem>
  <TabItem value="checkbox" label="checkbox.twig">
``` twig
...
```
    ...
    <TabItem value="group" label="group.twig">
``` twig
{% import "freeform/_templates/formatting/basic-light/_row.twig" as rowMacro %}
