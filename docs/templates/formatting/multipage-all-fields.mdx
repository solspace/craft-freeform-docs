...
import B51Photo from '../assets/img/bootstrap-5-multipage-all-fields-1.png';
import B52Photo from '../assets/img/bootstrap-5-multipage-all-fields-2.png';
...
<Photo img={B51Photo} alt="Multipage All Fields Example 1" />
<Photo img={B52Photo} alt="Multipage All Fields Example 2" />
