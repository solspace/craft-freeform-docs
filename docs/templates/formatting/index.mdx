...
import OverviewIcon from '../../assets/icons/archive.png';
import SampleTemplatesIcon from '../../assets/icons/magic-wand.png';
import TemplateOverridesIcon from '../../assets/icons/settings.png';
import ExamplesIcon from '../../assets/icons/edit.png';
...
The most common and hastle-free approach is to use the **formatting template** assigned to the form and load a [Form query](../queries/form) using the `render` method in your template. In templates that you want your forms to show up in, you simply just insert one line of code:
...
:::tip
[Need to pass a custom property to a formatting template, e.g. toggle display of the form title, etc?](guides/passing-custom-property-to-formatting-template/)
:::

### Code Your Form Directly in the Template

If you absolutely prefer to do so, you can use a [Form query](../queries/form) with the `renderTag` to code your form directly inside the template you need it to load in. This can definitely work against you if you intend on placing the form in more than one page.
...
| :---------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <div class="sample-templates-icon"><Photo img={SolspaceIcon} alt="Solspace"/>[Basic Light](./basic-light/)</div>                                      | Framework&nbsp;Agnostic | A neatly styled basic formatting template.                                                                                                                                                                                 |
| <div class="sample-templates-icon"><Photo img={SolspaceIcon} alt="Solspace"/> [Basic Light](./basic-light/) </div>                                    | Framework&nbsp;Agnostic | A neatly styled basic formatting template.                                                                                                                                                                                 |
| <div class="sample-templates-icon"><Photo img={SolspaceIcon} alt="Solspace"/> [Basic Dark](./basic-dark/) </div>                                      | Framework Agnostic      | A neatly styled basic _dark mode_ formatting template.                                                                                                                                                                     |
| <div class="sample-templates-icon"><Photo img={SolspaceIcon} alt="Solspace"/> [Basic Floating Labels](./basic-floating-labels/) </div>                | Framework Agnostic      | A neatly styled basic formatting template that displays labels in the center of the inputs and shrinks them to the top-left when clicked and/or contains a value.                                                          |
| <div class="sample-templates-icon"><Photo img={SolspaceIcon} alt="Solspace"/> [Conversational](./conversational/) </div>                              | Framework Agnostic      | A neatly styled basic formatting template that displays one field at a time and smoothly scrolls down to the next question until complete. Similar to how _Typeform_ displays forms. Also a great choice for survey forms. |
| <div class="sample-templates-icon"><Photo img={SolspaceIcon} alt="Solspace"/> [Multipage All Fields](./multipage-all-fields/) </div>                  | Framework Agnostic      | A neatly styled basic formatting template that displays ALL fields for a multipage form for the purpose of reviewing/previewing fields on other pages.                                                                     |
| <div class="sample-templates-icon"><Photo img={GridIcon} alt="Grid"/> [Grid](./grid/) </div>                                                          | Barebones               | A very basic starter template that requires additional CSS to style it.                                                                                                                                                    |
| <div class="sample-templates-icon"><Photo img={GridIcon} alt="Flexbox"/> [Flexbox](./flexbox/) </div>                                                 | Barebones               | A very basic starter template that requires additional CSS to style it.                                                                                                                                                    |
| <div class="sample-templates-icon"><Photo img={BootstrapIcon} alt="Bootstrap 5"/> [Bootstrap 5](./bootstrap-5/) </div>                                | Popular Framework       | An implementation of Bootstrap 5.                                                                                                                                                                                          |
| <div class="sample-templates-icon"><Photo img={BootstrapIcon} alt="Bootstrap 5"/> [Bootstrap 5 Dark Mode](./bootstrap-5-dark/) </div>                 | Popular Framework       | An implementation of Bootstrap 5 that uses the dark theme.                                                                                                                                                                 |
| <div class="sample-templates-icon"><Photo img={BootstrapIcon} alt="Bootstrap 5"/> [Bootstrap 5 Floating Labels](./bootstrap-5-floating-labels/)</div> | Popular Framework       | An implementation of Bootstrap 5 that uses the floating labels feature.                                                                                                                                                    |
| <div class="sample-templates-icon"><Photo img={TailwindIcon} alt="Tailwind 3"/> [Tailwind 3](./tailwind-3/) </div>                                    | Popular Framework       | An implementation of the Tailwind CSS 3 framework.                                                                                                                                                                         |
| <div class="sample-templates-icon"><Photo img={FoundationIcon} alt="Foundation 6"/> [Foundation 6](./foundation-6/) </div>                            | Popular Framework       | An implementation of the Foundation 6 framework.                                                                                                                                                                           |
...
:::tip
[Need to pass dynamic data such as the current URL, logged in user data, or data from another element to your form fields?](../../user-guides/guides/dynamic-data/passing-dynamic-data-to-forms)
:::
...
:::tip
[Need to populate field options at template level for automated formatting templates? Check out the guide for workaround options.](../../user-guides/guides/dynamic-data/populate-field-options-at-template-level)
:::
