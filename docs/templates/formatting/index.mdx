...
:::tip
[Need to pass dynamic data such as the current URL, logged in user data, or data from another element to your form fields?](guides/passing-dynamic-data-to-forms/)
:::
...
:::tip
[Need to populate field options at template level for automated formatting templates? Check out the guide for workaround options.](guides/populate-field-options-at-template-level/)
:::
