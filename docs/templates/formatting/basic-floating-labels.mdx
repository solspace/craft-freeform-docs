...
import BasicFloatingLabelsPhoto from '../assets/img/basic-floating-labels.png';
...
<CodeTabs>
<FolderTitle directoryName="/basic-floating-labels/" />
<TabItems>
...
.freeform-row
  [class*='freeform-col-'].freeform-fieldtype-credit-card.floating
  > div
  > div {
  display: block;
  position: relative;
...
.freeform-row
  [class*='freeform-col-'].freeform-fieldtype-file-dnd.floating
  label,
.freeform-row
...
<CodeTabItem
  filetype="link"
  label="fields/"
  link="#/basic-floating-labels/fields/"
/>
...
<FolderTitle directoryName="/basic-floating-labels/fields/" />
...
<iframe
  title="App Demo"
  id="app-demo"
  src="https://demo.solspace.net/craft/freeform-demo/templates/basic-light/contact"
  scrolling="yes"
  height="1600px"
  width="100%"
  class="app-demo"
