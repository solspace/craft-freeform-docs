...
A bool variable, which will be `true` if the form has the **Duplicate Check** setting enabled ([duplicate submission check](../../submissions/overview/#submission-limits)) and the user has already submitted the form.
