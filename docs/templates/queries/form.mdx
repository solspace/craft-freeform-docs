...
- `elements: true` <Badge type="feature" text="Renamed in 5.0+" /> - disable any [Element](../../integrations/elements/) integrations
  ...
  :::
- `payments: true` - disable [Payment](../../integrations/stripe-payments/) integrations
