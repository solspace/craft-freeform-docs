...
:::tip
[Options for handling the Success Return URL on forms.](guides/success-return-on-forms/)
:::
...
:::tip
[Need to pass a custom property to a formatting template, e.g. toggle display of the form title, etc?](../../user-guides/guides/dynamic-data/passing-custom-property-to-formatting-template)
:::
