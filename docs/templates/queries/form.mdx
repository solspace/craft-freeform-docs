...
:::tip
[Need to pass a custom property to a formatting template, e.g. toggle display of the form title, etc?](../../guides/guides/dynamic-data/passing-custom-property-to-formatting-template)
:::
