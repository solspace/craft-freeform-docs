...
- Not all types of forms can be intuitively edited (e.g. [Payment](../integrations/stripe-payments/) forms, some complex ones, etc).
- Editing [Payment](../integrations/stripe-payments/) forms will NOT update payment details, but instead will make a new submission/charge.
...
Inside the [Settings → Limits](../forms/builder/#settings) area in the [form builder](../forms/builder), a **Duplicate Check** setting exists to allow you to limit the number of times a specific user can submit the form.
...
Inside the [Settings → Limits](../forms/builder/#settings) area in the [form builder](../forms/builder), a **Stop Submissions After Date** setting exists to allow you to prevent new submissions of the form after the specified date.
