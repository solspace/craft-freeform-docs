...
Freeform includes a _Freeform Submissions_ field type (and [Freeform Form](../forms/fieldtype/)), which allows you to assign/relate submissions to other element types such as Craft Entries.

<Photo img={FieldtypeSubmissionsVideo} alt="Freeform Submissions Fieldtype" />
