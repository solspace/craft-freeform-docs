...
import GTMCheckPhoto from './assets/img/chcek-gtm.png';
...
- Go to the ['Single' integration section in Freeform Settings](../../configuration/settings#email-marketing) (**Freeform → Settings → Integrations → Single**).
