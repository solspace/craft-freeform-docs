...
This integration allows you to map Freeform submission data to [Craft User](https://craftcms.com/docs/5.x/reference/element-types/users.html), essentially creating a powerful [User Registration form](../guides/speciality-forms/user-registration-forms).
...
:::tip
[Check out our guide for a specialized look at creating User registration forms.](../guides/speciality-forms/user-registration-forms)
:::
