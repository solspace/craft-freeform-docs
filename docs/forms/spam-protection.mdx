...
- [reCAPTCHA v2 Invisible](../integrations/recaptcha/) <BadgeGroup><Badge type="lite" text="Lite" /><Badge type="pro" text="Pro" /></BadgeGroup>
- [reCAPTCHA v3](../integrations/recaptcha/) <BadgeGroup><Badge type="lite" text="Lite" /><Badge type="pro" text="Pro" /></BadgeGroup>
- [hCaptcha Checkbox](../integrations/hcaptcha/) <BadgeGroup><Badge type="lite" text="Lite" /><Badge type="pro" text="Pro" /></BadgeGroup>
- [hCaptcha Invisible](../integrations/hcaptcha/) <BadgeGroup><Badge type="lite" text="Lite" /><Badge type="pro" text="Pro" /></BadgeGroup>
