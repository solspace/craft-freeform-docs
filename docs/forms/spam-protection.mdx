...
:::tip
[Check out the guide on Spam Protection best practices.](../user-guides/guides/best-practices/spam-protection-best-practices)
:::
...
You can specify the behavior Freeform takes when the test fails with the [Spam Protection Behavior](../configuration/settings/#spam-protection) setting:
...
- [Challenge - Checkbox (v2)](../integrations/recaptcha/)
- [Challenge - Invisible (v2)](../integrations/recaptcha/) <BadgeGroup><Badge type="lite" text="Lite" /><Badge type="pro" text="Pro" /></BadgeGroup>
- [Score Based (v3)](../integrations/recaptcha/) <BadgeGroup><Badge type="lite" text="Lite" /><Badge type="pro" text="Pro" /></BadgeGroup>

### hCaptcha

- [Checkbox](../integrations/hcaptcha) <BadgeGroup><Badge type="lite" text="Lite" /><Badge type="pro" text="Pro" /></BadgeGroup>
- [Invisible](../integrations/hcaptcha) <BadgeGroup><Badge type="lite" text="Lite" /><Badge type="pro" text="Pro" /></BadgeGroup>
