...
The top of the **Forms** dashboard page will conveniently let you know if something is wrong by displaying a banner indicating the number of errors that Freeform logged, if available, as well as [Update Notices](../configuration/notices-alerts/) to keep you informed about issues that may specifically affect your site.
