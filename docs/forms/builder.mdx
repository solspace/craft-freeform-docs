...
import FreeformSurveyIcon from './assets/icons/freeform-surveys.png';
...
import FormDashboardVideo from './assets/videos/form-dashboard.mp4';
...
- **Preview** - this is where you will actively see an interactive live preview of what your form will look like (roughly - ultimately the form styling and appearance is up to your [formatting template](../templates/formatting/)).
...
Please see the [Submission Limits](../submissions/overview#submission-limits) documentation for more information about available options, including setting limits for the entire form.
...
:::tip
[Need to display submission data from previous pages as a confirmation screen, etc?](../user-guides/guides/dynamic-data/displaying-submission-data-from-previous-pages)
:::

:::tip
[Quick troubleshooting the most commonly reported issues with your form's appearance, behavior, or submission of the form on the front end.](../user-guides/guides/testing/troubleshooting-form-issues)
:::
