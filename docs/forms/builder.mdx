...
- **Use AJAX** - enables Freeform's [built-in automated AJAX submit support](../guides/templating/ajax-forms/). Once enabled, Freeform will handle the rest (as long as you're using standard template formatting - very custom formatting templates may not work properly).
...
:::tip
[Need to display submission data from previous pages as a confirmation screen, etc?](../guides/dynamic-data/displaying-submission-data-from-previous-pages)
:::

:::tip
[Quick troubleshooting the most commonly reported issues with your form's appearance, behavior, or submission of the form on the front end.](../guides/testing/troubleshooting-form-issues)
:::
