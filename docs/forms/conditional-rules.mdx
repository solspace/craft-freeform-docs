...
<VerticalStepWrapper>
  <StepMarkdown>
    Click the Rules tab in the form builder. Then choose a field, group or page
    from the field layout map on the left.
  </StepMarkdown>
  <StepMarkdown>
    The field, group or page you selected will then load in the right column.
    Click the Add rules button and configure which field(s) will affect whether
    the selected field will be shown or hidden, based on the criteria set for
    each.
  </StepMarkdown>
  <StepMarkdown>
    If you wish to add more than one condition for a field, click the Add a
    Condition button. If you have more than one condition for a field, you may
    also set whether all or any of the conditions need to be met.
  </StepMarkdown>
</VerticalStepWrapper>
