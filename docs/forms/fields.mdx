...
Controlling the format for submit buttons is now done through the new `buttons` namespace available in the [Template Overrides](../templates/formatting.mdx#template-overrides) feature.
