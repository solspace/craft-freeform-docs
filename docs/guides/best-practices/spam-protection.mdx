...
<StepMarkdown>
### Enable a Captcha Service

Though not always necessary, we strongly recommend using [reCAPTCHA](../../integrations/recaptcha) or [hCaptcha](../../integrations/hcaptcha) on your forms to offer the most robust spam protection.

- **reCAPTCHA Score-based (v3)** offers the least intrusive spam protection for your customers. It's free to set up and is available on the Lite and Pro editions of Freeform.
...
Please see the [Caching Forms documentation guide](../templating/caching-forms/) for more information.
...
Please see the [Using Vue.js documentation guide](../headless/vuejs) for more information.
...
:::warning
We strongly recommend using [reCAPTCHA](../../integrations/recaptcha) or [hCaptcha](../../integrations/hcaptcha) on your forms to offer the most robust spam protection. However, the express guide below gets basic protection for your site.
:::
...
It may also be necessary to use [reCAPTCHA](../../integrations/recaptcha) or [hCaptcha](../../integrations/hcaptcha) on your forms to offer the most robust spam protection.