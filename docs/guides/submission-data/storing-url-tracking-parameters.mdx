...
- Create and add 3 new [Hidden](../../forms/fields#hidden) fields to your form layout with the handles of:
    - `utm_campaign`
    - `utm_source`
    - `utm_medium`
...
:::tip
[Check out our other guide for passing along other types of data to Freeform form fields.](../dynamic-data/passing-dynamic-data-to-forms/)
:::
