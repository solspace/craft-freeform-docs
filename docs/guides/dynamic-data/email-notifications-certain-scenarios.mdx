...
You can achieve a dynamic template level email notification by using the [Dynamic Template Notifications](../../forms/email-notifications#dynamic-template-notifications) feature. You would use this in place of regular [Admin Notifications](../../forms/email-notifications#admin), which are not flexible.
...
You can achieve this by having 3 different form templates that load the same form, but no [Admin Notifications](../../forms/email-notifications#admin-notifications) and only use [Dynamic Template Notifications](../../forms/email-notifications#dynamic-template-notifications) to generate them.
