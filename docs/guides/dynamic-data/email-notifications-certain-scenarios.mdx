...
You can achieve a dynamic template level email notification by using the [Template-based Notifications](../../forms/email-notifications/#template-based) feature. You would use this in place of regular [Admin Notifications](../../forms/email-notifications/#admin), which are not flexible.
...
You can achieve this by having 3 different form templates that load the same form, but no [Admin Notifications](../../forms/email-notifications/#admin) and only use [Template-based Notifications](../../forms/email-notifications/#template-based) to generate them.
