...
import PluginStoreInstallPhoto from './assets/photos/plugin-store-install.png';
import PluginStorePhoto from './assets/photos/plugin-store.png';
import SwitchEditionPhoto from './assets/photos/switch-editions-purchase-3.png';
import UpdatePhoto from './assets/photos/updates.png';

import ClipboardIcon from './assets/icons/clipboard.png';
import BoxIcon from './assets/icons/box.png';
import UpdateArrowsIcon from './assets/icons/update-arrows.png';
import BagIcon from './assets/icons/bag.png';
import SwapIcon from './assets/icons/swap.png';
import QuestionSignIcon from './assets/icons/question-sign.png';
...
Freeform uses the **Craft Updates Service**, which means that every time there's an update available, it'll show up in the _Updates_ area (**Utilities** → **Updates**) of the Craft control panel. You can then review the changelog there, or [view it here](./changelog/).
...
```nix app-window showLineNumbers
