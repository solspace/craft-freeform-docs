...
2. Inside your regular template:
   ...
   - Add the `formAttributes: { "data-skip-html-reload": true },` parameter to your [Form query](../../../templates/queries/formx).
