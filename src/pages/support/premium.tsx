      ...
      <main className="max-w-5xl m-auto my-12">
        ...
        <blockquote className="text-sm font-italic rounded-md p-4 mb-7 form-styling">
          <p className="text-blue-500 mb-2">
            ...
            talking to the lead developer. Gustavs was amazing to work with and
            helped me through my issue quickly and efficiently. I can’t
            recommend the Premium Support enough, and will definitely be using
        ...
        <div className="mt-10">
          ...
          <div className="mx-auto p-6 bg-[#181d27] text-white rounded-b-md rounded-tr-md border border-solid border-[#ff6624]">
            <Admonition type="alert">
              If you have any questions about our Premium Support service, feel
              free to <Link href="/support">contact us</Link> and we can
              determine if our Premium Support service is right for you. If
              you're ready to proceed, fill out the form, select the number of
              hours and submit payment below:
            </Admonition>
            <iframe
              title="Support Form"
              id="support-form"
