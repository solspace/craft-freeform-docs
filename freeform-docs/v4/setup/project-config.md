---
title: Craft Freeform 4.x - Project Config
...
::: new /craft/freeform/v5/configuration/project-config/
Freeform
:::
...
If you wish to manage the configuration of Freeform settings via Craft's [Project Config](https://craftcms.com/docs/4.x/project-config.html), here's a list of every setting currently available:
