---
title: Craft Freeform 4.x - Bootstrap 5 Multipage All Fields - Example Formatting Template
description: This Bootstrap 5 formatting template displays ALL fields for a multipage form for the purpose of reviewing/previewing fields on other pages.
prev: false
next: false
---
...
::: new /craft/freeform/v5/templates/formatting/multipage-all-fields/
Freeform
:::
...
![Bootstrap 5 Multipage All Fields Example 1](../../images/formatting/bootstrap-5-multipage-all-fields-1.png)

![Bootstrap 5 Multipage All Fields Example 2](../../images/formatting/bootstrap-5-multipage-all-fields-2.png)

::: video 78LAmvZ0yoA/?start=257
