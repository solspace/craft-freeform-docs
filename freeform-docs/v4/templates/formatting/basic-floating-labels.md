---
title: Craft Freeform 4.x - Basic Floating Labels - Example Formatting Template
...
::: new /craft/freeform/v5/templates/formatting/basic-floating-labels/
Freeform
:::
...
.freeform-row [class*="freeform-col-"].freeform-fieldtype-cc_details.floating > div > div {
    display: block;
    position: relative;
}
...
.freeform-row [class*="freeform-col-"].freeform-fieldtype-file_drag_and_drop.floating label,
