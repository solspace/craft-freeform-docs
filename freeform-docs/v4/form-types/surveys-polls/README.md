---
title: Craft Freeform 4.x - Surveys & Polls Form Type
...
::: new /craft/freeform/v5/forms/types/surveys-polls
Freeform
:::
...
The following features are available for any form inside the core _Freeform_ plugin, but become powerful when combined with the _Surveys & Polls_ form type:

- Intuitive [form builder](../../overview/form-builder/) that allows site admins to easily create and customize surveys and polls.
- Powerful [field types](../../overview/fields/) to handle every kind of question and flow.
- Break up your surveys into [multiple pages](../../overview/multi-page-forms/) so users don't get overwhelmed.
- [Conditionally show and hide](../../overview/conditional-rules/) questions or skip pages entirely, based on the selection of other fields.
- [Limit how many times a user can submit](../../overview/submission-limits/) the survey or poll, or if they need to be logged in, etc.
- Set a [close date](../../overview/submission-limits#stop-after-date) for surveys and polls.
- Allow users to [save & continue](../../overview/save-continue-later/) completing the survey later.
- A wide variety of built-in [spam protection](../../overview/spam-protection/) measures.
- Send [email notifications](../../overview/email-notifications/) to form submitters and/or site admins upon completion.
...
- Will this be a single page form or will you break up your surveys into [multiple pages](../../overview/multi-page-forms) so users don't get overwhelmed?
- Which [field types](../../overview/fields) will you use? A wide variety of options are available to suit every kind of question and flow.
- Will you [conditionally show and hide](../../overview/conditional-rules/) some questions or skip pages entirely, based on the selection of other fields?
- Does the survey have a [close date](../../overview/submission-limits#stop-after-date)?
...
![Surveys & Polls Settings](../../images/cp_surveys-polls-settings.png)
