---
title: Craft Freeform 2.x - Returning Submit to Same Page
prev: false
next: false
---

::: version /craft/freeform/v5/guides/return-same-page/
Freeform
:::
...
Aside from the obvious of using [AJAX](../templating-extras/ajax-forms.md), you can achieve this by adding a query in the success URL instead of an additional segment, etc.
