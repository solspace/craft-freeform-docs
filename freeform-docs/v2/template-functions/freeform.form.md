---
title: Craft Freeform 2.x - freeform.form
prev: false
next: false
---
...
* Second parameter (optional) is an object of the following overriding options:
	...
	* `status` <Badge type="feature" text="2.5.0+" /> <a href="#param-status" id="param-status" class="docs-anchor">#</a>
	...
	* `fieldIdPrefix: 'myform-'` <Badge type="feature" text="2.2.0+" /> <a href="#param-fieldidprefix" id="param-fieldidprefix" class="docs-anchor">#</a>
