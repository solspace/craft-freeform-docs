---
title: Craft Freeform 5.x - Row object
...
The Row object contains all of the [Fields](./field/) assigned to it in the form builder. It can contain up to 4 fields/columns. The Row object doesn't contain any properties, methods or non render field types such as a [Hidden](../../forms/fields/#hidden) fields. Instead, it's an iterable object where you have to iterate over it to get the [Fields](./field/) contained within.
