...
- A `honeypot` entry if you're using the [Freeform Honeypot](../forms/spam-protection#freeform-honeypot).
- A `reCaptcha` entry if you're using the [Freeform Captchas](../forms/spam-protection#captchas).
