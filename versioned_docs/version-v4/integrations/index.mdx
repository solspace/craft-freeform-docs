...
:::tip
[Can I make my own API integration?](../guides/developer/custom-integrations)
:::
...
:::tip
[Can I make my own CRM or Email Marketing API integration?](../guides/developer/custom-integrations)
:::
...
- Mailing list integrations appear as a checkbox that can be drag and dropped into the form builder interface:
  ...
  - Your form must include an [Email](../forms/fields#email) field type, which must then be assigned to the **Target Email Field** setting.
...
<IconCards
  items={[
    ...
    },
    {
      ...
      link: '../guides/submission-data/google-tag-manager',
    },
    {
