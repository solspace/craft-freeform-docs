...
The Freeform [Date & Time](../forms/fields) field comes packed with a built-in, optional [flatpickr](https://flatpickr.js.org/) instance. The _flatpickr_ instance can be customized via the following events available through the [Freeform JS Plugin](./js-plugin):
