...
<FlexCards
  items={[
    ...
    },
    {
      title: 'Updating',
      description:
        'Instructions for updating from 4.x to newer versions of Freeform 4.x.',
...
```sh command-line showLineNumbers
composer composer require solspace/craft-freeform:4.0.2
```
...
:::warning
**If you're upgrading from Freeform 3.x**, please see the special [upgrade guide here](./updating-freeform/).
:::
