...
1. [reCAPTCHA](../../forms/spam-protection#captchas) or [hCaptcha](../../forms/spam-protection#captchas)
...
Though not always necessary, we strongly recommend using [reCAPTCHA](../../forms/spam-protection#captchas) or [hCaptcha](../../forms/spam-protection#captchas) on your forms to offer the most robust spam protection.
...
:::warning
We strongly recommend using [reCAPTCHA](../../forms/spam-protection#captchas) or [hCaptcha](../../forms/spam-protection#captchas) on your forms to offer the most robust spam protection. However, the express guide below gets basic protection for your site.
:::
...
It may also be necessary to use [reCAPTCHA](../../forms/spam-protection#captchas) or [hCaptcha](../../forms/spam-protection#captchas) on your forms to offer the most robust spam protection.