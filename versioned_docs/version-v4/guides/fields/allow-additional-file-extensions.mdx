...
If you wish to allow more file extensions to your [File Upload](../../forms/fields/#file-upload) or [File Upload Drag & Drop](../../forms/fields/#file-upload-drag--drop) fields, you will need to add the [extraAllowedFileExtensions](https://craftcms.com/docs/5.x/reference/config/general.html#extraallowedfileextensions) (and possibly [extraFileKinds](https://craftcms.com/docs/5.x/reference/config/general.html#extrafilekinds)) config items to your Craft config file.
...
- Inside the form builder, click on any of the [File Upload](../../forms/fields/#file-upload) or [File Upload Drag & Drop](../../forms/fields/#file-upload-drag--drop) fields in your form.
