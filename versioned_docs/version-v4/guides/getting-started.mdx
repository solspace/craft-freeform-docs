...
import BasicLightPhoto from './assets/img/basic-light.png';
...
Freeform centers itself around letting admins and clients enjoy the experience of building and managing simple or complex forms in an intuitive interface that lets you see a live preview of the forms you're building. We refer to this as the [form builder](../forms/builder/), where almost everything is at your fingertips as it aims to stay out of your way and let you do as much as possible without moving around to other areas in the control panel. At the same time, Freeform is very powerful and flexible, so there is also a wide variety of other features, settings and options.
...
- [Admin Notifications](../forms/email-notifications/#admin)
...
<Photo img={BasicLightPhoto} alt="Basic Light Example" />
...
To add some overrides to the form, such as setting some classes or even [inserting values dynamically](./dynamic-data/passing-dynamic-data-to-forms) from the page, your code might look something like this:
