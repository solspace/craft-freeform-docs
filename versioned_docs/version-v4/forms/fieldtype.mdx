...
Freeform includes a _Freeform Form_ field type (and [Freeform Submissions](../submissions/fieldtype/)), which allows you to assign/relate forms to other element types such as Craft Entries.
