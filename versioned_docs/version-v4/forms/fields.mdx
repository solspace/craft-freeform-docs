...
:::tip
[Would you like to allow more file extensions in file uploads?](../guides/fields/allow-additional-file-extensions/)
:::
...
:::tip
[Want to display a Number field as a range slider?](../guides/fields/range-slider-number)
:::
...
:::
:::tip
[Looking to include an additional "Other" choice that displays an input field for users to fill in their own value?](../guides/fields/other-option-for-fields)
:::
...
:::tip
[Want to display a Text input as a Color Picker?](../guides/fields/color-picker-text)
:::
...
:::tip
[Want to allow front end users to use a rich text editor such as **TinyMCE** on a textarea field?](../guides/fields/tinymce-editor-textarea)
:::
