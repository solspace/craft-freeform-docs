...
2. Go to the [Email Marketing section in Freeform Settings](../configuration/settings#email-marketing) (**Freeform > Settings > Email Marketing**) and click on the existing _Constant Contact_ integration you have configured.
