...
This documentation page assumes you have read over the [CRM Integration Overview](./index.mdx#crm). If you have not yet read it, please do so now. We also assume that you have a [Pardot](https://www.pardot.com) account already. This integration requires that you have _Freeform Pro_. If you currently have Freeform Lite, you can purchase an upgrade to Freeform Pro.

## Compatibility

- Field mapping to standard and most custom _Prospect_ object fields. There may be some limitations on types of fields that can be mapped.
...
- Select _Pardot (v5)_ from the **Service Provider** select dropdown.
...
- Enter your Pardot Business ID into the **Pardot Business Unit ID** field.
  - To find the Pardot Business Unit ID, go to _Marketing Setup_, in the _Quick Find_ box, enter `Pardot`, and then select _Pardot Account Setup_. Copy the business unit ID for the Pardot instance you want to use.
