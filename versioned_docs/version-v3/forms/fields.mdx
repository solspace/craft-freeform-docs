...
import MultipleSelectPhoto from './assets/img/multiple-select.png';
...
- **GUIDE:** [Populate Field Options at Template Level](../guides/dynamic-data/populate-field-options-at-template-level)
