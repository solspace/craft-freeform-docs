...
:::info
To disable the Freeform Honeypot per form at template level, add the `disableHoneypot: true` parameter to the [Form query](../templates/queries/form/).<Badge type="feature" text="3.12+" />
:::
...
To disable reCAPTCHA v2 Invisible and v3 per form at template level, add the `disableRecaptcha: true` parameter to the [Form query](../templates/queries/form/).<Badge type="feature" text="3.9.0+" />
