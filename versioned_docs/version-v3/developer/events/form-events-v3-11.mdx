...
:::info
**You're viewing the v3.11 version of these docs**. To switch to the v3.12 docs, [click here to view the revised v3.12 documentation](./form). All of these events will continue to work with Freeform 3.12, but have been deprecated.
:::
