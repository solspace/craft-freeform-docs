...
<Photo img={SliderLookPhoto} alt="Range Slider" />

</StepMarkdown>
<StepMarkdown>
### Step 4

In order for this to automatically happen inside a [formatting template](../../templates/formatting/), you'll want to create a new one if you haven't already. If you using the [Basic Light](../../templates/formatting/basic-light/) formatting template as a starting point, your code might look something like this:

```twig {18-25} showLineNumbers
