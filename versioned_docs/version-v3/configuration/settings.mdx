...
:::info
The **Automatically Scroll to Form on Errors and Multipage forms?** feature can have its behavior can been manipulated with the [Autoscroll Events](../developer/js-plugin#autoscroll-events). <Badge type="feature" text="3.10.8+" />
:::
...
This area is for users that wish to use Twig-based HTML template files for email notifications. See [Email Notifications](../forms/email-notifications) documentation for more information about implementation.
