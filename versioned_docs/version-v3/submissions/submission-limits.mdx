...
Inside the [Validation](../forms/builder#validation) tab (lock icon) in the [form builder](../forms/builder), an option exists to allow you to limit the number of times a specific user can submit the form. Look for this setting:
