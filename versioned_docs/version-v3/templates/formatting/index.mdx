...
2. With the [freeform.form](../queries/form/) template function.
...
Have a look at [freeform.form function](../queries/form/) and [Form object](../queries/form/) for a full list of properties and parameters.
