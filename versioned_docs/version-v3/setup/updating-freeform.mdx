...
| :---------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------: |
| [Build User registration forms](../guides/speciality-forms/user-registration-forms) |                                  <span class="red">×</span>                                   |                                                     <span class="yellow">✓</span>                                                      |
...
3. Carefully review the [changelog](./changelog) for Freeform 3.x as well as the new [key features/changes table](#key-changes) above.
...
If that still does not resolve the issue, please see the [Changing Editions](./installing-updating#changing-editions) documentation.
