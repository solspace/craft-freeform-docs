...
If you wish to override these settings with a config file, please see the [Config Overrides](./config-overrides) documentation.
...
- **Spam Protection** <a href="#spam-protection" id="spam-protection" class="docs-anchor">#</a>
  ...
  - For more information, visit the [Spam Protection documentation](../forms/spam-protection).
...
- **Include Freeform Scripts in the Page Footer?** <a href="#scripts-footer" id="scripts-footer" class="docs-anchor">#</a>
  ...
  - Freeform will automatically insert javascript in the footer of the page for features such as [Spam Protection](../forms/spam-protection), Submit disable on click, and other special fieldtypes. If you prefer to have this load inside the `<form></form>` tags, you can disable this setting.
