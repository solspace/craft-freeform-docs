...
A [variety of email notification options](../forms/email-notifications) are available with Freeform. For the purpose of this example, we'll keep it simple and create an email notification for Admin(s) and an email notification for the user submitting the form.
...
Be sure to check out your form in the [demo templates](../configuration/demo-templates) that come with Freeform if you want to quickly see your forms in action. These demo templates let you have a fully functioning area on your website with just a couple clicks!

## Customizing Rendering of Form

If you choose to use the [`form.render()`](../templates/queries/form) approach as used in the example above in step 5, you can customize the rendering of your form by applying overrides.
...
Be sure to check out the [freeform.form](../templates/queries/form) template function documentation for more information.
