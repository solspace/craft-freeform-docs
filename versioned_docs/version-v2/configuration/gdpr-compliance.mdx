...
- To enable it, see the **[Allow Users to Opt-in](../forms/builder/#form-settings)** setting inside the Form Settings areas of Composer. In the select dropdown, select a Checkbox fieldtype you want to be the designated opt-in field, or choose Disabled to not use this feature.
