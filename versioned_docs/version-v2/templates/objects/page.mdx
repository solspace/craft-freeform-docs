...
The Page object contains all of the [Rows](./row) assigned to it in the [form builder](../../forms/builder/). It also contains the index of the page and its label.
...
Use this to iterate over all [Rows](./row) in this page. You can also just iterate over the [Page](./page) object to yield the same results (examples provided below).
