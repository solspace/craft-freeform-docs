...
The Salesforce Lead integration allows you the choice of entering your API keys and credentials via a config file instead if you wish. For more information about Freeform's config overrides, please see [Project Config](../configuration/project-config) documentation. A brief overview is below:
