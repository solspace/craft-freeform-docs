...
:::info
To see a variety of complete working AJAX examples for the most popular frameworks, install and check out our [Demo Templates](../../configuration/demo-templates) included with Freeform. The JS used in the demo templates work in the latest browsers with plain vanilla javascript and do not require any JS libraries, like jQuery, etc.
:::
