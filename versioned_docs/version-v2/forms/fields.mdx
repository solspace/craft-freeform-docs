...
- **Password** <Badge type="feature" text="2.2.0+" /> <a href="#fields-password" id="fields-password" class="docs-anchor">#</a>
  - Allows you to collect a password from a submitter, **but NOT store the value in the database**.
    - Useful for [creating a user registration form](../guides/speciality-forms/user-registration-forms) (using the [Element Connections](./element-connections) feature) and in other very specific use-cases where you're passing the password off somewhere else.
