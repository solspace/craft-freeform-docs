...
- **Email Body** <a href="#email-body" id="email-body" class="docs-anchor">#</a>
  - The HTML body of the email notification to be sent.
    ...
    - Can iterate over submission values from the [Submission object](../templates/objects/submission) (as long as you're [storing submitted data)
...
You can also have your notification email template code iterate over submission values from the [Submission object](../templates/objects/submission) as long as you're storing submitted data like this:
