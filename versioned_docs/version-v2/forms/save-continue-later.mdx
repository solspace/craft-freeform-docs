...
- 👎 **Editing Forms**: there is currently no support for saving progress while [editing submissions](../submissions/submission-editing). If attempted, Freeform will just create a duplicate submission instead.
